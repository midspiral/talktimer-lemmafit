...
const App = {
  // Lap constructors
  Lap: (timestamp: number, duration: number, section: string, selected: boolean) => TalkTimer.Lap.create_Lap(new BigNumber(timestamp), new BigNumber(duration), _dafny.Seq.UnicodeFromString(section), selected),
